...
with_node \
  ...
  --target "/Users/rwilley/Desktop/RedVelvet/VelvetVerify/velvet-verify-app/ios/Pods/Target Support Files/Pods-velvetverifyapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/rwilley/Desktop/RedVelvet/VelvetVerify/velvet-verify-app/ios/velvetverifyapp/velvetverifyapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
